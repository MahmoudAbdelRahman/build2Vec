#This model builds on Node2Vec deveoped by Elior Cohen
...
class Build2Vec:
    ...
    def __init__(self, graph: nx.Graph, dimensions: int = 10, walk_length: int = 50, num_walks: int = 50, p: float = 1,
        ...
        """
        Initiates the Build2Vec object, precomputes walking probabilities and generates the walks.
    ...
    def fit(self, **skip_gram_params) -> gensim.models.Word2Vec:
        ...
        :param skip_gram_params: Parameters for gensim.models.Word2Vec - do not supply 'size' / 'vector_size' it is
            taken from the Build2Vec 'dimensions' parameter
